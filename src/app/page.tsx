    ...
    <main>
      ...
      flex-col">
        ...
        <h1 className='text-5xl md:text-8xl bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-600 font-sans font-bold mb-4'>
          Automate your Social Media with Linkqueai
        </h1>
              </div>
       }
       ></ContainerScroll>
          ...
          <CardContainer className="inter-var ">
            <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-neutral-500/[0.1] dark:bg-black dark:border-[#E2CBFF] border-black/[0.1] w-full md:!w-[350px] h-auto rounded-xl p-6 border">
              ...
              <CardItem
                ...
                className="text-neutral-500 text-sm max-w-sm mt-2 dark:text-neutral-300"
              >
                Perfect for small businesses looking to elevate their social media game. Experience powerful automation with added flexibility!
                <ul className="my-4 flex flex-col gap-2">
                  <li className="flex items-center gap-2">
                    <CheckIcon />20 Automations
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckIcon />
          ...
          <CardContainer className="inter-var ">
            <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-neutral-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full md:!w-[350px] h-auto rounded-xl p-6 border">
              ...
              <CardItem
                ...
                className="text-neutral-500 text-sm max-w-sm mt-2 dark:text-neutral-300"
              >
                Designed for businesses ready to fully automate and scale their social media management. Unleash the full potential!
                <ul className="my-4 flex flex-col gap-2">
                  <li className="flex items-center gap-2">
